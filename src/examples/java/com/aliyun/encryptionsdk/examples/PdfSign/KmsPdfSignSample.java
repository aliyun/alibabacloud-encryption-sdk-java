...
public class KmsPdfSignSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DefaultAcsClient kmsClient = kmsiTextSignature.kmsClient();
    ...
    public static HashMap<String, Object> getCertificatesFromSecretManager(DefaultAcsClient kmsClient, String secretName) throws Exception {
        ...
        Map<String,String> map = new Gson().fromJson(certificateFromSecretManager, new TypeToken<HashMap<String,String>>(){}.getType());
        String cert = map.get("Certificate");
        String chain = map.get("CertificateChain");
